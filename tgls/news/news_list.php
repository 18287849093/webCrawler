    ...
    <script>
        layui.use(['laypage', 'layer'], function() {
            ...
            table.render({
                elem: '#demo'
                ,height: 800
               // ,url: '../../application/news/news_data.php'//数据接口
            ...
            table.on('tool(test)', function(obj){ //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
                ...
                function deluser(data,index,obj){
                    $.ajax({
                        url: '../../application/news/news_data.php',    //这个是后台的路由地址
                        type: "POST",
                ...
                function showEdit(datas) {
                    ...
                    var editHtml = '<form id="form1" class="layui-form" method="post" action="../../application/museumData/sys_data_edit.php" style="width:460px; margin-top: 20px;">\
                           ...
                           <div class="layui-form-item">\
                             ...
                             <div class="layui-input-block">\
                               <input type="text" name="title1" value="'+datas.title2+'" lay-verify="title" autocomplete="off" placeholder="请输入标题" class="layui-input">\
                             </div>\
                           </div>\
                           <div class="layui-form-item">\
                    ...
                    layer.open({
                        ...
                        yes: function (layIndex) {
                            $.ajax({
                                url: '../../application/news/news_edit.php',    //这个是后台的路由地址
                                type: "POST",
