...
<script>
    ...
    layui.use(['laypage', 'layer'], function() {
        ...
        table.render({
            elem: '#demo'
            ,height: 800
            ,url: '../../application/bullet/bullet_list.php'//数据接口
            ,method:'post'
            ...
            cols: [[ //表头
                ...
                ,{field: 'order', title: '序号', width:80, sort: true, fixed: 'left', totalRowText: '合计：'}
                ,{field: 'animeName', title: '动漫名称', width:180}
                ,{field: 'comment', title: '弹幕', width: 400, sort: true, totalRow: true}
